# proactive messages Bot - `proactiveMessagesBot`
...
3. Give the bot a handle (ex: `proactiveMessagesBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://proactivemessages.azurewebsites.net/api/messages`
